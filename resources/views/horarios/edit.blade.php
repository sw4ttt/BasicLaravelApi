        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/horarios/edit/'.$horario->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('lugar') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="lugar" type="text" class="form-control" name="lugar" value="{{ old('lugar')?old('lugar'):$horario->lugar }}" data-validation="length" data-validation-length="2-50" data-validation-optional="true" required>
                        @if ($errors->has('lugar'))
                            <span class="help-block">

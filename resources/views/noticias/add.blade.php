        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/noticias/add') }}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="title" type="text" class="form-control" name="title" value="{{ old('title') }}" data-validation="length" data-validation-length="min5,max100" data-validation-optional="true" required autofocus>
                        @if ($errors->has('title'))
                ...
                <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="content" type="text" class="form-control" name="content" value="{{ old('content') }}" data-validation="length" data-validation-length="min5,max100" data-validation-optional="true" required>
